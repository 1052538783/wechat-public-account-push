...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx72863a5cca4524db',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '6336047b4e4d10f4beb32f2b424a70f7',
  ...
  USERS: [
    {
      ...
      id: 'oMqsy6do7Y3DCzw0vNgR4q0HDpfE',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'cVRaXs99mZ4VHI4IPIvBGID5FzleZpJ9CY_9ZTcbwfk',
      // 所在省份
      province: '安徽',
      // 所在城市
      city: '马鞍山',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '2001', date: '12-24',
        },
        {
          type: '节日', name: '恋爱纪念日', year: '2021', date: '01-02',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '任记朋', year: '2022', date: '05-02',
        },
        {
  ...
  CALLBACK_TEMPLATE_ID: 'cVRaXs99mZ4VHI4IPIvBGID5FzleZpJ9CY_9ZTcbwfk',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'oMqsy6YHPk5x5sCNEq1mHiMJRevw',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
